...
rm -rf /tmp/scylla-parquet/my_table*
cat $1 | cqlsh
JAVA_HOME="/home/sme/.sdkman/candidates/java/8.0.242.hs-adpt" nodetool flush mk && \
JAVA_HOME="/home/sme/.sdkman/candidates/java/8.0.242.hs-adpt" nodetool compact mk
